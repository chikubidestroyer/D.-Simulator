...
def init_game():
    ...
    with con:
        ...
        con.execute('INSERT INTO building (building_id, building_name, lockdown) VALUES (?, ?, ?)', (vertex_id, 'Home', 0))

        cur = con.execute('INSERT INTO income_range (low, high) VALUES (1000, 2000)')
        income_level = cur.lastrowid

        cur = con.execute('INSERT INTO home (home_building_id, income_level) VALUES (?, ?)', (vertex_id, income_level))
        con.execute('INSERT INTO inhabitant (name, home_building_id, loc_building_id, custody, dead) VALUES (?, ?, ?, ?, ?)', ('John Doe', vertex_id, vertex_id, 0, 0))
